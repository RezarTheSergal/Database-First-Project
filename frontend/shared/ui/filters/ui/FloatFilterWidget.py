...
class FloatFilterWidget(BaseFilterWidget):
    """Filter widget for float fields using your UI component"""
    ...
    def clear_value(self):
        ...
        self.input_widget.setValue(0.0)  # Default to 0.0 or min value

    def is_empty(self):
        """Check if the filter is empty"""
        return self.get_filter_value() is None or self.get_filter_value() == 0.0
